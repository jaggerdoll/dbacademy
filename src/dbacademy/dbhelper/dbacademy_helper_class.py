...
class DBAcademyHelper:
    ...
    def get_dbacademy_datasets_path() -> str:
        ...
        """
        from dbacademy import dbgems
        return dbgems.get_spark_config(DBAcademyHelper.SPARK_CONF_PATHS_DATASETS, default="abfss://unity-catalog-storage@dbstorageey5dyhfd7opxu.dfs.core.windows.net/140507238462271/dbacademy-datasets")
    ...
    def get_dbacademy_users_path() -> str:
        ...
        """
        from dbacademy import dbgems
        return dbgems.get_spark_config(DBAcademyHelper.SPARK_CONF_PATHS_USERS, default="abfss://unity-catalog-storage@dbstorageey5dyhfd7opxu.dfs.core.windows.net/140507238462271/dbacademy-users")
